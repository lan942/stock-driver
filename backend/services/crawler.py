...
_list_crawler = StockListCrawler()
_realtime_crawler = StockRealtimeCrawler()
...
class StockCrawler:
    ...
    def fetch_stock_list():
        try:
            return _list_crawler.fetch_stock_list_df()
    ...
    def fetch_stock_realtime():
        try:
            return _realtime_crawler.fetch_realtime_df()
        except Exception as e:
            print(f"获取实时行情失败: {e}")
            return pd.DataFrame()
